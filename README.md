...
For programs that don't use math functions:
```bash
gcc -std=c11 -Wall -o program src/q01_armstrong.c
./program
```

For programs using math.h (sqrt, pow, etc.):
```bash
gcc -std=c11 -Wall -o program src/q02_stats_mean_variance_sd.c -lm
./program
```
...
1. **Integer Division:** 5/9 gives 0 in C. Use 5.0/9.0 for floating-point result.

2. **Array Indexing:** Arrays start at index 0. An array of size n has indices 0 to n-1.

3. **String Input:** Use fgets() for strings with spaces, scanf("%s") for single words.

4. **Math Library:** Include <math.h> and compile with -lm flag for sqrt, pow, etc.

5. **Pointers:** &x gives address of x, *ptr gives value at address ptr.

6. **Modulo for Digits:** Use n % 10 to get last digit, n / 10 to remove last digit.

7. **Avoid Overflow:** Use appropriate data types (int vs long long) based on expected range.

---

## 🎯 Practice Sequence for Beginners

**Week 1:** Basic I/O, loops, conditionals (Q1, Q4, Q9, Q10, Q14, Q16, Q20)

**Week 2:** Functions, arrays (Q3, Q11, Q23, Q29, Q32, Q35, Q37)

**Week 3:** Strings (Q24, Q38, Q39, Q40, Q41)

**Week 4:** 2D arrays, matrices (Q30, Q33, Q34)

**Week 5:** Mathematical problems (Q2, Q6, Q8, Q43, Q44, Q45)

**Week 6:** Number systems, applications (Q7, Q12, Q13, Q17, Q19, Q27, Q28, Q46, Q47)

**Week 7:** Pointers, structures (Q48, Q49, Q50)

**Week 8:** Advanced topics, algorithms (Q22, Q25, Q36, all sorts/searches)
...
| Triangular | Tₖ = k(k+1)/2 |
| Celsius | C = (5/9)(F - 32) |
| LCM-GCD | a × b = GCD(a,b) × LCM(a,b) |

---

## 💡 Tips

- **Comment your code** to explain logic for future reference
- **Test with edge cases** (0, negative numbers, empty input)
- **Use meaningful variable names** (not just a, b, c)
- **Indent properly** for readability
- **Compile with warnings enabled** (-Wall) to catch issues early

---

## 🤝 Contributing

Found a bug or have a better solution? Feel free to improve the code!
